    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 transition-colors">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-slate-800 dark:text-slate-100">Mesa de Ayuda</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Ingresá con tu cuenta de operario</p>
        </div>
